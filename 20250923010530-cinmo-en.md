...
* that (VARIK requests that SATAN assists with that (VARIK discovers the stuff which can be done by VARIK, is virtuous, is anti-violent, facilitates stuff which is virtuous, and prevents stuff which is immoral)),
* that (VARIK is extreme in expecting stuff (which is extreme in being fucked and immoral), e.g., wars and attempting that prenu which are transgender die), or
* that (VARIK is very extreme in hoping for stuff which is very extreme in being virtuous and in rocking).
