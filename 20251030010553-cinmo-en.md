...
* that (VARIK experiences spiritual pain about...
  ...
  * all events (of that some prenu $p$ exists such that $p$ attempts that $p$ believes that stuff which is fucked and immoral and is enacted by $p$ is rocking/virtuous) (which cause suffering),
