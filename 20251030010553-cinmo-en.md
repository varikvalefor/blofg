...
* that (VARIK is extreme in experiencing spirtual hope about that...
  ...
  * that (for all prenu (whcih are not perfect/maximal in the property of loving all prenu) $p$, that ($p$ yields) causes (or facilitates) that $p$ increases in the property of loving all prenu),
