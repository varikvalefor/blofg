...
* that (VARIK is slightly annoyed by a thing which is stated by a prenu which is not VARIK) (which is fucked and immoral),
* that (VARIK is not annoyed by a thing which is stated by a prenu which is not VARIK),
...
* that (VARIK is extreme in experiencing spiritual hope about...
  ...
  * that (spiritually considering prenu which enact stuff which annoys facilitates decreasing in being annoyed),
...
## That (Language is Insufficient for the Property of Loving All Prenu)
Stuff which is grammatical with regard to a language is insufficient for being an explanation of the property of loving all prenu.  That (language stuff is insufficient) does not facilitate explaining the property of loving all prenu.

But language stuff is not necessary for explaining the property of loving all prenu, and loving all prenu is the explanation of loving all prenu.  VARIK experiences (about the situation which is described by the sentence which precedes the current sentence) spiritual joy and spiritual hope.

VARIK does not experience spiritual pain about that (language stuff is insufficient).  VARIK experiences spiritual joy about that (the property of loving all prenu is sufficient for not being linguistically explainable).
