...
* that (VARIK experiences spiritual pain about...
  ...
  * that (competitive society facilitates stuff (which is fucked and immoral) (which includes that (prenu do not wait for determining whether a thing is virtuous), that (prenu forget (or whatever) about the property of loving all prenu), that (prenu are hated), that (a thing which is forgotten/whatever is that a thing which is possible is that considering-and-waiting precedes acting), and whatnot)),
