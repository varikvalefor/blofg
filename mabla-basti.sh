...
#
# .i ku'i jitfa fa le du'u ko'a mapti lo ro co'e  .i troci zo'e naje lo nu ko'a mapti lo se me'oi .kibykaerni.

sed -e "s/\\* le ka ce'u mutce le ka ko'a goi ce'u xi re gleki le su'u ko'a nonlingeni je le su'u ko'a jimpe le du'u ko'a nonlingeni kei kei je le su'u le ka ce'u xi ci nonlingeni cu jinzi ko'a gi ga ce/* that (VARIK is extreme in being glad about that (VARIK is agender), that (VARIK understands that VARIK is agender), and that (being agender is inherent to VARIK)),/" |\
...
sed -e "s/\\* le ka ce'u zu'edji lo ka ce'u xi re badgau je sidju lo ro prenu noi mupli tu'a ke'a fa lo zukte be lo mabla ja tolvu'e kei poi ke'a ckaji le ka ce'u xi re to'e vlile je cu jai toljursa kei ni'i zo'e joi lo su'u ke'a mapti py ky goi le ka ro da poi ke'a prenu zo'u ce'u xi re prami da gi ga ce/* that (VARIK intends that (VARIK protects and assists all prenu (which are exemplified by prenu which enact stuff which is fucked or immoral)) (which is anti-violent, is gentle, and is in accordance with the property of loving all prenu)),/" |\
...
sed -e "s/\\* lo ro nu su'o da poi ke'a prenu zo'u su'o de poi ke'a prenu zo'u cfari fa lo nu da de skuxai ja ckasu poi ke'a xrani de ja cu nu da na co'e ja troci lo nu xajmi de gi ga je/\\* all events (of that some prenu $p$ exists such that some prenu $r$ exists such that $p$ insults $r$, and the event of insulting offends $r$ or is not an event of that $p$ attempts that $r$ is amused),/" |\
sed -e "s/\\* lo ro nu malku'i lo su'o prenu gi ga je/\\* all events (of that some prenu is mistreated),/" |\
sed -e "s/\\* lo ro nu lo su'o prenu cu banzuka lo ka co'e ja troci lo nu jitro ce'u xi re tu'a lo lijda kei kei lo ka ce'u xi re terpa lo nu ri sezbanzu lo su'u ri co'e ja re'enje jurpei kei kei ja lo nu lo prenu jenai du be ce'u xi re cu seljda lo na lijda be ce'u xi re kei ja cu co'e ja jinvi lo du'u lo ro prenu cu seljda naja cu co'e ja troci lo nu ri jitro lo prenu jenai du be ri tu'a lo lijda gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ is sufficient (for that $p$ fears that ($p$ is independent in spiritually/whatever-ly considering stuff) or that (some prenu which is not $p$ "follows" a religion which is not "followed" by $p$) or opines/whatever that (for all prenu $r$, if $r$ is religious, then $r$ attempts "religiously" controlling/manipulating prenu which are not $r$)) in that prenu attempt/whatever to "religiously" control/manipulate $p$),/" |\
sed -e "s/\\* lo ro nu lo su'o prenu cu terpa lo nu ri co'e ja re'enje jurpei gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ fears that $p$ spiritually/whatever-ly considers stuff),/" |\
sed -e "s/\\* lo ro nu lo su'o prenu cu banzuka lo ka ce'u xi re terpa lo nu ri krici jenai djuno noi ke'a sarcu lo nu lijda ce'u xi re kei kei lo ka ce'u xi re co'e ja troci lo nu tolna'e tu'a lo lijda be ri kei kei noi ke'a jai filri'a ja rinka lo nu zenba lo ka ce'u xi re xlafri gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ is sufficient (for that attempts/whatever that evidence indicates the religion/whatever of $p$) in fearing that ($p$ believes and does not know) (which is necessary for being religious)),/" |\
sed -e "s/\\* lo ro nu lo su'o prenu cu terpa lo nu ri krici jenai djuno gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ fears that $p$ believes and does not know),/" |\
sed -e "s/\\* lo ro nu su'o da poi ke'a prenu zo'u da co'e ja jinvi lo du'u mabla ja tolvu'e fa lo ro da'i nu da seljda lo su'o co'e poi da na djuno lo du'u ke'a lijda lo su'o prenu jenai du be da gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ opines/whatever that all hypothetical events of that (some religion $r$ exists such that $p$ "follows" $r$, and no prenu which is not $p$ "follows" $r$) are fucked or immoral),/" |\
sed -e "s/\\* lo ro nu lo su'o prenu cu co'e ja jinvi lo du'u sarcu fa lo nu ri seljda pe'a lo su'o na te krici be fi ri gi ga je/\\* all events (of that some prenu $p$ exists such that $p$ opines/whatever that a thing which is necessary is that $p$ "follows" a religion/whatever which is not believed by $p$),/"
