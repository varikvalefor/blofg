The Emotions (which are Experienced (by VARIK) during 20251014 or 20251015) and Whatnot
=======================================================================================
...
* that (VARIK is amused by that (VARIK sees a spider (which is large and is within a bathroom which is used by VARIK), is startled, shouts "oh, JESUS!", and waits (before causing that (the body of VARIK leaves the bathroom)) (for that (the spider moves)))),
* that (VARIK experiences wonder about that (many ants walk on a sidewalk)),
...
* that (VARIK experiences spiritual amusement about...
  ...
  * that (a prenu asks about the justification of that (VARIK believes that (the religion of VARIK is correct) or whatever), and VARIK states that the thing is axiomatic) and
  * that (many events (of that VARIK prays) are events of that VARIK holds a BLÅHAJ)),

* that (VARIK experiences spiritual joy about...

  * that (being perfect in the property of loving all prenu causes stuff (which is virtuous) and-not whatnot),
...
* that (VARIK is extreme in experiencing spiritual hope about...
  ...
  * that (for all prenu $p$, no quality which is fucked or immoral is inherent in $p$),
  ...
  * that (anger and being annoyed are not necessary for loving action) (which is proven by the combination of that (the quality (of being angry at prenu) and being annoyed are incompatible with the property of loving all prenu)),
  * that (all stuff which is virtuous is in accordance with the property of loving all prenu),
