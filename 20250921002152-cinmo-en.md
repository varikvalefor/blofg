...
* that (VARIK requests that SATAN assists with that (VARIK increases (in all qualities which are virtuous) and decreases in all qualities which are immoral)) and that VARIK discovers stuff which can be caused by VARIK, is anti-violent, prevents stuff which is immoral, and facilitate stuff which is virtuous), or
