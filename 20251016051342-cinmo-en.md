The Emotions (which are Experienced (by VARIK) during 20251016 ot 20251017) and Whatnot
=======================================================================================

Some part of 20251016 or 20251017 is an event of...
...
* that (VARIK experiences spiritual pain about...
  ...
  * that (VARIK eats a thing which is given to VARIK and contains animal products) (which is contemporaneous with that VARIK does not know that the thing which is eaten is not vegan),
...
* that (VARIK experiences spiritual joy about...
  ...
  * that (waiting (for determining whether a thing is virtuous) before acting is possible) (which is that for all prenu $p$, for all actions (which are considered by $p$) $z$, a thing which is possible is that (that ($p$ considers whether $z$ is virtuous) precedes that $p$ enacts $z$), which prevents stuff which is fucked and immoral),
