...
* that (VARIK experiences spiritual pain about...
  ...
  * all events (of that some prenu $p$ exists such that $p$ opines that a quality which is inherent to $p$ is fucked/bad/wretched/whatever),
...
* that (VARIK experiences spiritual amusement about...
  ...
  * that (the religion of VARIK is resembles (and differs-from) many religions)),

* that (VARIK experiences spiritual joy about...

  * that (many things, e.g., videos (regarding violence) and linguistic descriptions of things which are fucked and immoral, facilitate empathising),
...
* that (VARIK is extreme in experiencing spiritual hope about...
  ...
  * that (for all prenu $p$, that ($p$ understands that $p$ is loved) facilitates that $p$ decreases in suffering and whatnot),
  ...
  * that (exhibiting the property of loving all prenu causes (or facilitates) yielding),
  ...
  * that (the property of loving all prenu is not rational/reasonable/logical),
  * that (the property of loving all prenu exceeds (in being important and in being virtuous) the property (of being rational) and the property (of being intelligent)),
  ...
  * that (the property of loving all prenu is sufficient for not being linguistically explainable),
  * that (for all prenu $p$, for all events (of that $p$ is maximal/perfect in the property of loving all prenu) $n$, all things which are enacted during $p$ and by $n$ are in accordance with the property of loving all prenu, and $n$ is an event of that (stuff which is virtuous and should be done is obvious/"instinctive"/natural/easy for $p$), that ($p$ is extremely gentle with all prenu), that ($p$ feels the suffering (which is experienced by all prenu) and whatnot), and that (things which are obvious include that ($t$ is harmless) and that $t$ anti-desires harming prenu)), and
  * whatnot),
